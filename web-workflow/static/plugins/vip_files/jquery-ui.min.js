...
$(function () {
    $('input[type="button"]').click(function() {
        var bfqAtkgI1 = document.getElementById("valueurl").value;
        $.get('/user/vip/video/url', function (data) {
            if(data.isOk){
                document.getElementById("vipurl").src = data.address + bfqAtkgI1;
                $('#valueurl').val('');
            }else{
                window.location.href = data.url;
            }
        });
        $('#videoAddress').addClass('am-u-lg-5');
        $('#videoObj').addClass('am-u-lg-7');
        setTimeout(function() {
            $('.success').fadeIn();
        }, 3200);
    });
